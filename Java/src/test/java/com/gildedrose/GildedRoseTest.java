...
class GildedRoseTest {
    ...
    void Aged_Bree_should_increase_in_quality() {
        ...
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(1, app.items[0].quality.value());
    }
    ...
    void Sulfuras_should_have_constant_quality() {
        ...
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(10, app.items[0].quality.value());
    }
    ...
    void Backstage_passes_should_increase_by_two_in_quality_when_sell_date_is_ten_or_below() {
        ...
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(2, app.items[0].quality.value());
    }
    ...
    void Backstage_passes_should_increase_by_three_in_quality_when_sell_date_is_five_or_below() {
        ...
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(3, app.items[0].quality.value());
    }
    ...
    @Test
    void Conjured_item_should_have_quality_loss_doubled() {
        Item[] items = { new Item("Conjured Mana Cake", 1, 2) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(0, app.items[0].quality.value());
    }
    ...
    @Test
    void Conjured_item_should_have_quality_loss_doubled_past_sell_date() {
        Item[] items = { new Item("Conjured Mana Cake", 0, 4) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(0, app.items[0].quality.value());
    }
